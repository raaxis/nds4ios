...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // text
    cell.textLabel.text = @"Resume In-Game Save";
    cell.detailTextLabel.text = @"Continue playing from in-game save";
    
    // detail
    if (indexPath.row > 0) {
        cell.textLabel.text = (indexPath.row == 1 && self.game.hasPauseState) ? @"Resume Saved Game State" : [self.game nameOfSaveStateAtIndex:indexPath.row - 1];
